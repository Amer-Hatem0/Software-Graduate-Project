...
namespace GraduateProject_Core.Interfaces
{
    public interface ISupervisorRepository
    {
        ...
        Task<List<PatientAssignmentDTO>> GetPatientAssignmentsAsync();
        Task<IEnumerable<DoctorPerformanceDTO>> GetDoctorsPerformanceAsync();
        Task<SupervisorProfileDTO> GetSupervisorProfileAsync(int userId);
        Task<bool> UpdateSupervisorProfileAsync(int supervisorId, SupervisorUpdateDTO dto);
