...
namespace GraduateProject_Infrastructure.Repositories
{
    public class PatientRepository : IPatientRepository
    {
        ...
        //public async Task<bool> UpdatePatientProfileAsync(int userId, PatientProfileDTO dto)
        //{
        //    var patient = await _context.Patients
        //        .Include(p => p.User)
        //        .FirstOrDefaultAsync(p => p.UserId == userId);
        ...
        //    patient.CurrentStatus = dto.CurrentStatus;
        ...
        public async Task<bool> UpdatePatientProfileAsync(int userId, PatientProfileDTO dto, IFormFile profileImage)
        {
            var patient = await _context.Patients
                .Include(p => p.User)
                .FirstOrDefaultAsync(p => p.UserId == userId);
            ...
            // ✅ حفظ الصورة إن تم رفعها
            if (profileImage != null)
            {
                var uploadsFolder = Path.Combine("wwwroot", "uploads", "patients");
                ...
                using (var stream = new FileStream(filePath, FileMode.Create))
                {
                 ...
                 patient.ImageUrl = $"/uploads/patients/{fileName}";
            }
        ...
        public async Task<IEnumerable<DoctorDTO>> GetAvailableDoctorsAsync()
        {
            return await _context.Doctors
                ...
                .Select(d => new DoctorDTO
                {
                    ...
                    Specialization = string.IsNullOrEmpty(d.User.Specialization) ? "Not specified" : d.User.Specialization
                }).ToListAsync();
        }
