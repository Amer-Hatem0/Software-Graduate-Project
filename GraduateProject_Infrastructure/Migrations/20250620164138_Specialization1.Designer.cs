...
namespace GraduateProject_Infrastructure.Migrations
{
    ...
    [Migration("20250620164138_Specialization1")]
    partial class Specialization1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GraduateProject_Core.Models.Message", b =>
                {
            ...
            modelBuilder.Entity("GraduateProject_Core.Models.PatientReport", b =>
                {
            ...
            modelBuilder.Entity("GraduateProject_Core.Models.Procedure", b =>
                {
            ...
            modelBuilder.Entity("GraduateProject_Core.Models.RescheduleRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GraduateProject_Core.Models.Appointment", b =>
                {
                    ...
                    b.HasOne("GraduateProject_Core.Models.AppointmentStatus", "AppointmentStatus")
                        .WithMany("Appointments")
            ...
            modelBuilder.Entity("GraduateProject_Core.Models.Message", b =>
                {
                    b.HasOne("GraduateProject_Core.Models.Users", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverUserID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("GraduateProject_Core.Models.Users", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("GraduateProject_Core.Models.RescheduleRequest", b =>
                {
                    b.HasOne("GraduateProject_Core.Models.Appointment", "Appointment")
