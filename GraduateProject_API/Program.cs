...
using GraduateProject_Core.Mappings;
    ...
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            builder.Services.AddCors(options =>
            {
                ...
                {
                    policy.WithOrigins("http://localhost:5173") // رابط React
                          .AllowAnyHeader()
                          .AllowAnyMethod()
                          .AllowCredentials()
                          .WithExposedHeaders("*");
            ...
            builder.Services.AddScoped<IAISymptomAnalysisRepository, AISymptomAnalysisRepository>();
